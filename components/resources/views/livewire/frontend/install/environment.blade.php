<div>
        ...
        <div class="form-group">
            <label for="purchase_code">{{ __('Purchase code') }} ( <a href="https://NullJungle.com" class="text-gradient text-primary" target="_blank">Nulled By NullJungle</a> )</label>
            <input type="text" wire:model="purchase_code" id="purchase_code" value="NullJungle" class="form-control @error('purchase_code') is-invalid @enderror" required />
        </div>
